...
-- 따라서 transaction 기능을 사용하기 위해서는 auto-commit 설정을 해제 해줘야한다.

-- java 복습 
-- boolean 기본값은 false -> false = 0, true = 1
...
-- start transaction 구문을 작성을 하면 하나의 과정으로 인식을 하고
-- commit, rollback 과정을 수행할 수 있다.
