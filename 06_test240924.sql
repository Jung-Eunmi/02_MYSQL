...
-- 문제 5. 부서코드가 D6이고 급여를 200만원보다 많이 받는 직원의
-- 이름, 부서코드, 급여 조회
select
	EMP_NAME,
    DEPT_CODE,
...
-- 문제 7. EMPLOYEE테이블에서 급여를 350만원 이상
-- 550만원 이하를 받는
...
-- 문제 9. EMPLOYEE 테이블에서 '하'가 이름에 포함된
-- 직원의 이름, 주민번호, 부서코드 조회
select
	EMP_NAME,
    EMP_NO,
...
-- 문제 10. EMPLOYEE테이블에서 전화번호 국번이 9로 시작하는
...
-- 문제 11. EMPLOYEE테이블에서 전화번호 국번이 4자리 이면서
...
-- 문제 13. 이씨성이 아닌 직원의 사번, 이름, 이메일주소 조회
select
	EMP_ID,
    EMP_NAME,
    EMAIL
...
-- 문제 14. J2직급의 급여 200만원 이상 받는 직원이거나
